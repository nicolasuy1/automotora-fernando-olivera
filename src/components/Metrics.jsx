...
const metrics = [
  { icon: WalletCards, title: "Financiación flexible", text: "Opciones por banco o por la casa según cada situación." },
  { icon: RefreshCw, title: "Permutamos tu vehículo", text: "Tomamos autos o motos como parte de pago." },
  { icon: CarFront, title: "Autos, camionetas y motos", text: "Stock variado y en movimiento constante." },
  { icon: MessageCircle, title: "Atención directa con Fernando", text: "Consultas claras por WhatsApp, sin vueltas." },
];
  ...
  return (
    <SectionReveal className="relative mx-auto max-w-7xl px-5 py-16 sm:px-6 lg:px-8">
      <div className="mb-8 max-w-2xl">
        ...
        <h2 className="mt-3 text-3xl font-black leading-tight text-white sm:text-5xl">Lo que nos diferencia.</h2>
      </div>
